...
public class ProductGroups {
	...
	public static class ProductComponent extends PComponentSet{

	}
	
	public static class PComponentGroup extends MenuDataItem{
		private int PGroupID;
	...
	public static class PComponentSet extends PComponentGroup{
		...
		public void setOrderSetID(int childOrderId) {
			this.orderSetId = childOrderId;
		}
		...
		public double getFlexibleIncludePrice() {
			return FlexibleIncludePrice;
		}
		public void setFlexibleIncludePrice(double flexibleIncludePrice) {
